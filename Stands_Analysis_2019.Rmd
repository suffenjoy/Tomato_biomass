...
p1 = ggplot(weather_season, aes(x = Date, y = VPD.noon))+geom_line(color="red")+theme_bw()
p1
p2 = ggplot(weather_season, aes(x = Date, y = Radiation.noon,color=2))+geom_line(color="blue")+theme_bw()
p2
p3 = ggplot(weather_season, aes(x = Date, y = AirTemp.noon))+geom_line(color="darkgreen")+theme_bw()
